...
const Color darkGreen50 = Color(0x80095D40);

const Color lightGreen = Color(0xFFE2F1CE);

const Color beige = Color(0xFFFFFBE2);

const Color red = Color(0xFFA30000);

const Color darkBrown = Color(0xFF8E6E34);

const Color grey100 = Color(0xFF333333);

const Color grey85 = Color(0xD9333333);

const Color grey50 = Color(0x80333333);

const Color taupe = Color(0xFF7D7171);

// Fonts constant used for the entire app
...
const TextStyle textBeige =
    TextStyle(fontFamily: 'Montserrat', fontSize: 18, color: beige, fontWeight: FontWeight.w600);
...
const TextStyle textDarkGreen =
    TextStyle(fontFamily: 'Montserrat', fontSize: 18, color: darkGreen, fontWeight: FontWeight.w600);
...
const TextStyle textDarkGrey =
    TextStyle(fontFamily: 'Montserrat', fontSize: 18, color: grey85, fontWeight: FontWeight.w600);

const TextStyle textRed = TextStyle(fontFamily: 'Montserrat', fontSize: 18, color: red, fontWeight: FontWeight.w600);

const TextStyle textMediumRed =
    TextStyle(fontFamily: 'Montserrat', fontSize: 14, color: red, fontWeight: FontWeight.w600);

const TextStyle textSmallRed =
    TextStyle(fontFamily: 'Montserrat', fontSize: 8, color: red, fontWeight: FontWeight.w600);
