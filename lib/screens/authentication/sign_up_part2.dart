...
import 'package:local_et_toi/blocs/sign_up_bloc/sign_up_bloc.dart';
...
class _SignUpPageState2 extends State<SignUpPage2> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<SignUpBloc>(
      create: (context) => SignUpBloc(myUserRepository: context.read<AuthenticationBloc>().userRepository),
      child: Scaffold(
